...
var Chromeless = /** @class */ (function () {
    ...
    Chromeless.prototype.click = function (selector, x, y) {
        this.queue.enqueue({ type: 'click', selector: selector, x: x, y: y });
        return this;
    };
    ...
    Chromeless.prototype.body = function () {
        this.lastReturnPromise = this.queue.process({ type: 'returnBody' });
        return new Chromeless({}, this);
    };
