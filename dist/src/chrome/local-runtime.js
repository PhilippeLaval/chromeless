...
var LocalRuntime = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (command.type) {
                    ...
                    case 'click':
                        return [2 /*return*/, this.click(command.selector, command.x, command.y)];
                    case 'returnCode':
                    ...
                    case 'returnBody':
                        return [2 /*return*/, this.returnBody()];
    ...
    LocalRuntime.prototype.click = function (selector, x, y) {
        return __awaiter(this, void 0, void 0, function () {
            var exists, scale;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [4 /*yield*/, util_1.click(this.client, selector, scale, x, y)];
                    case 6:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [4 /*yield*/, util_1.screenshot(this.client, selector, options)];
                    case 5:
                        data = _a.sent();
    ...
    // Returns the S3 url or local file path
    LocalRuntime.prototype.returnBody = function () {
        return __awaiter(this, void 0, void 0, function () {
            var filePath, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
