import { Client, Cookie, DeviceMetrics, PdfOptions, BoxModel, Viewport, Headers, ScreenshotOptions } from './types';
...
export declare function click(client: Client, selector: string, scale: number, x?: number, y?: number): Promise<void>;
...
export declare function screenshot(client: Client, selector: string, options: ScreenshotOptions): Promise<string>;
